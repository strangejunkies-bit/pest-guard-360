...
if (quoteForm) {
  quoteForm.addEventListener('submit', async (event) => {
    ...
    formData.set('_subject', `New Pest Guard 360 quote request from ${name}`);
    ...
    try {
      ...
      if (formStatus) {
        ...
        formStatus.textContent = 'The request was not sent. Check your connection and try again, or email dsamaha88@gmail.com.';
      }
